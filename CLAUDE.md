...
const sql = neon(process.env.NEON_DATABASE_URL || 'postgresql://neondb_owner:npg_o3YETDg1IfBb@ep-young-lake-an4yj1r0-pooler.c-6.us-east-1.aws.neon.tech/neondb?sslmode=require');
